...
export function Navbar({ className }: NavbarProps) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-semibold rounded-full bg-gradient-to-b from-[#585858] to-[#1a1a1a] text-white shadow-inner shadow-black/30 hover:brightness-110 transition-all duration-200"
          >
      ...
      <AskAi open={isChatOpen} onOpenChange={setIsChatOpen} />
    </>
  );
}
